...
`$prometheus-strict` is a clean-room OWX planning skill for rigorous interview-driven planning before execution.
...
- **Oracle** synthesizes the approved plan and recommends the OWX-native handoff.
...
The skill returns a Prometheus Strict Plan with clarified requirements, resolved critique, an Oracle execution plan, a verification matrix, an optional durable artifact path under `.owx/plans/prometheus-strict/`, and clean-room credit.
