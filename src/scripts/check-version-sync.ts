...
const explore = TOML.parse(readFileSync(join(root, 'crates', 'owx-explore', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
const runtimeCore = TOML.parse(readFileSync(join(root, 'crates', 'owx-runtime-core', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
const mux = TOML.parse(readFileSync(join(root, 'crates', 'owx-mux', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
const api = TOML.parse(readFileSync(join(root, 'crates', 'owx-api', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
const runtime = TOML.parse(readFileSync(join(root, 'crates', 'owx-runtime', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
const sparkshell = TOML.parse(readFileSync(join(root, 'crates', 'owx-sparkshell', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
...
if ((api.package as Record<string, unknown>)?.version !== undefined && ((api.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('crates/owx-api/Cargo.toml must use version.workspace = true');
}
if ((explore.package as Record<string, unknown>)?.version !== undefined && ((explore.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('crates/owx-explore/Cargo.toml must use version.workspace = true');
}
if ((runtimeCore.package as Record<string, unknown>)?.version !== undefined && ((runtimeCore.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('crates/owx-runtime-core/Cargo.toml must use version.workspace = true');
}
if ((mux.package as Record<string, unknown>)?.version !== undefined && ((mux.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('crates/owx-mux/Cargo.toml must use version.workspace = true');
}
if ((runtime.package as Record<string, unknown>)?.version !== undefined && ((runtime.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('crates/owx-runtime/Cargo.toml must use version.workspace = true');
}
if ((sparkshell.package as Record<string, unknown>)?.version !== undefined && ((sparkshell.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('crates/owx-sparkshell/Cargo.toml must use version.workspace = true');
}
