...
const PROFILE_ENV_KEY = "OWX_NOTIFY_PROFILE";

function clearProfileEnv(): void {
  delete process.env[PROFILE_ENV_KEY];
  delete process.env.OWX_DISCORD_NOTIFIER_BOT_TOKEN;
  delete process.env.OWX_DISCORD_NOTIFIER_CHANNEL;
  delete process.env.OWX_DISCORD_WEBHOOK_URL;
  delete process.env.OWX_DISCORD_MENTION;
  delete process.env.OWX_TELEGRAM_BOT_TOKEN;
  delete process.env.OWX_TELEGRAM_CHAT_ID;
  delete process.env.OWX_SLACK_WEBHOOK_URL;
}
...
describe("resolveProfileConfig", () => {
  ...
  it("resolves OWX_NOTIFY_PROFILE env var when no explicit name", () => {
...
describe("getActiveProfileName", () => {
  ...
  it("returns env var value when OWX_NOTIFY_PROFILE is set", async () => {
...
describe("profile edge cases", () => {
  ...
  it("env vars merge into selected profile config", async () => {
    process.env.OWX_TELEGRAM_BOT_TOKEN = "env-token";
    process.env.OWX_TELEGRAM_CHAT_ID = "env-chat";
