...
export function buildAgentsModelTable(
  ...
  return [
    ...
    '',
    'Auto-generated by `owx setup` from the current `config.toml` plus OWX model overrides.',
    '',
...
export function upsertAgentsModelTable(
  ...
  const startIndex = content.indexOf(OWX_MODELS_START_MARKER);
  const endIndex = content.indexOf(OWX_MODELS_END_MARKER);
