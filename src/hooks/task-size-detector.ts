 ...
 * (mandatory enforcement). In OWX, Codex CLI does not support pre-tool hooks, so this
 * module serves as:
 ...
 *
 * The actual gate enforcement in OWX is advisory: AGENTS.md instructs the model to
