...
describe('prompt guidance catalog coverage', () => {
  for (const contract of [...CATALOG_CONTRACTS, ...LEGACY_PROMPT_CONTRACTS, ...SPECIALIZED_PROMPT_CONTRACTS, ...PRODUCT_TASTE_CONTRACTS, ...WRITER_TECHNICAL_CONTRACTS]) {
